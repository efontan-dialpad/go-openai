...
func (*failingMarshaller) marshal(value interface{}) ([]byte, error) {
	return []byte{}, errTestMarshallerFailed
}

func (*failingRequestBuilder) build(ctx context.Context, method, url string, requset interface{}) (*http.Request, error) {
